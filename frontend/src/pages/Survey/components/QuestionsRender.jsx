...
// const QuestionRender = ({ currentQuestion, surveyAnswers, handleInputChange, handleOptionClick, currentStep, selectedPills, handlePillSelect }) => {
//     return (
//         <>
...
//                     </StyledTextInputContainer>
//                 ))
//             ) : currentQuestion.type === 'option-pill' ? ( // 약물 추가 기능이 포함된 옵션
//                 <div>
//                     {/* 기존 옵션 (없음 등) 표시 */}
//                     <ButtonContainer>
...
//                         <AddPillButton_ver1 text="알러지 약물 추가" onClick={() => handlePillSelect('타이레놀')} />
//                     </AddPillButtonContainer>
